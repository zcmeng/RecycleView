...
import com.zcmeng.cyclerview.recyclerview.LRecyclerView;

import java.util.ArrayList;
import java.util.List;

public class MainActivity extends AppCompatActivity implements LucklyRecyclerView.OnLoadMoreListener, LucklyRecyclerView.OnRefreshListener, View.OnClickListener,LucklyRecyclerView.OnItemHeaderClickListener{
...
//        mLRecyclerView.setRefreshBackground(getResources().getDrawable(R.drawable.headerback));
        ...
        mLRecyclerView.setRefreshColor(getResources().getColor(R.color.grey_700));
